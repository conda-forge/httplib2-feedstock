...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=424&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/httplib2-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `httplib2` can be installed with `conda`:
...
```
mamba install httplib2
```

It is possible to list all of the versions of `httplib2` available on your platform with `conda`:
...
```
mamba search httplib2 --channel conda-forge
```
...
mamba repoquery search httplib2 --channel conda-forge

# List packages depending on `httplib2`:
mamba repoquery whoneeds httplib2 --channel conda-forge

# List dependencies of `httplib2`:
mamba repoquery depends httplib2 --channel conda-forge
```
